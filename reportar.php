...
<header><?php include 'header.php' ?></header>
    ...
    <form action="reporteProc.php" method="post" class="formulario" enctype="multipart/form-data">
    <div class=formul2>
        <h1>Información de Mascota</h1>
        
            <input type="text" name="nombrem" placeholder="Nombre de la Mascota" required class="input100">
            <input type="text" name="raza" id="" placeholder="raza" required class="input100">
        
		
            <label for="" class="lab">¿Hembra o macho?</label>
			<select name="sexom" id="" required class="input80">
            ...
            <input type="number" name="edad" id="" placeholder="Edad en meses" required class="input50">
            <input type="text" name="tam" id="" placeholder="tamaño en cm" required class="input50">
        ...
        <h1>Informacion personal</h1>
            <input type="text" name="nombrep" id="" placeholder="Nombre" required class="input50">
            <input type="text" name="apellidosp" id="" placeholder="Apellidos" required class="input50">
            <input type="email" name="correo" id="" placeholder="Correo@" required class="inputc">
            <input type="number" name="telefono" id="" placeholder="Telefono" required class="input50">
            
            <select name="distrito" required class="inputd">
